...
def crypto(bot, trigger):
    ...
    api_matic =  'https://api.coingecko.com/api/v3/coins/matic-network?localization=false&community_data=false&developer_data=false&sparkline=false'
...
#        mensaje = mensaje + f"[Alpha] {data['market_data']['current_price']['usd']}"
    ...
    if r.status_code != 200:
        ...
        mensaje = mensaje + f"[Matic] {data['market_data']['current_price']['usd']}"
